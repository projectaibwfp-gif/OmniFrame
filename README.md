...
- `GET /api/fansites` - zwraca promowane i wspierane fansite'y (TibiaData `v4/fansites`),
- `GET /api/guild/:name` - zwraca szczegóły gildii (TibiaData `v4/guild/{name}`),
- `GET /api/guilds/:world` - zwraca aktywne i formujące się gildie świata (TibiaData `v4/guilds/{world}`),
- `GET /api/house/:world/:houseId` - zwraca szczegóły domu (TibiaData `v4/house/{world}/{houseid}`),
- `GET /api/houses/:world/:town` - zwraca domy i guildhalle miasta (TibiaData `v4/houses/{world}/{town}`),
- `GET /api/spell/:spellId` - zwraca szczegóły zaklęcia (TibiaData `v4/spell/{spellid}`),
- `GET /api/spells` - zwraca pełną listę zaklęć (TibiaData `v4/spells`),
- `GET /api/world/:name` - zwraca szczegóły świata wraz z graczami online (TibiaData `v4/world/{name}`),
- `GET /api/worlds` - zwraca wszystkie światy regularne i turniejowe (TibiaData `v4/worlds`),

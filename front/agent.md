...
13. **Boostable bosses page**: Use backend endpoint `GET /api/boostable-bosses` and shared DTOs `BoostableBossDto` / `BoostableBossesDto` from `shared/api-contract.ts` as the source of truth.
